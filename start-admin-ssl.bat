...
where nginx >nul 2>&1
if %errorlevel% neq 0 (
    echo [错误] nginx未安装或未添加到PATH环境变量
    echo 请先安装nginx并添加到系统PATH
    pause
    exit /b 1
)
